...
# plt.plot(list(range(len(train_errors))), train_errors, marker='o', label=f'train_error')
# plt.plot(list(range(len(test_errors))), test_errors, marker='o', label=f'test_error')
# plt.title('training and testing errors for different number of trees in bagging')
